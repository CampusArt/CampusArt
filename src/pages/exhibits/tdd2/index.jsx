...
export default function TDD2() {
  ...
  const exhibits = [
    ...
    { title: "Double Pandemic", status: "published", bg: "https://i.ibb.co/bPxrM07/COMINGSOON6.jpg", author: "Seymour Sanchez", link: "double-pandemic-deadly-combination" },
    { title: "Sino ba kausap mo?", status: 'published', author: "Seymour Sanchez/ Katrina Juane / Vanessa Puenta / Erika Garalde / Dino Brucelas", link: "sino-ba-kausap-mo", bg: "https://i.ibb.co/KwYq0HT/sino-ba-kausap-mo.png" },
