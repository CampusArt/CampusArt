...
export default function Leni() {
  ...
  return (
    <main id="tdd2" className="template leni">
      ...
      <section>
        <div className="container">
          <p><strong>Synopsis</strong> <br/>“Maria Leonor” is an open letter to the beleaguered vice president of the Philippines and leader of the opposition, VP Maria Leonor “Leni” Gerona Robredo – one of the most, if not the most trolled, public officials in the country. Despite baseless accusations and ad hominem attacks against her, she continues to work with the relatively smaller budget that her office has gotten every year – providing free shuttle services for frontliners, swab tests, telehealth services, among others, and raising funds for relief operations nationwide. Last October 7, 2021, she announced that she is running for president in the coming election.</p>
          <p><strong>Director's Note</strong> <br/>The COVID-19 crisis has revealed that countries with women leaders like Denmark, Finland, Germany, Iceland, New Zealand and Slovakia have been shining examples of effective and vital leadership in their response to the pandemic. Despite challenges associated with them being women, they have been proactive in responding to the threat of the virus, seeking expert advice to inform health strategies, implementing social distancing restrictions early, and unifying their respective countries around a comprehensive response with compassionate and transparent communication. Meanwhile, in the Philippines, the administration continues to impose its might, preferring an approach other than the more appropriate medical solution to a health problem. A Filipina leader is relegated to the background.</p>
          <div className="flex">
            <img src={Leonor} alt="" style={{padding: "24px", width: '100%'}} />
            <p>Maria Leonor “Leni” Gerona Robredo won the vice-presidential contest in the 2016 elections. After five years, the Supreme Court, sitting as the Presidential Electoral Tribunal, unanimously upheld her victory by junking the electoral protest filed against her by losing presidential candidate Ferdinand “Bongbong” Marcos, Jr. Despite this, she continuously bears the brunt of being called a “fake VP” and other false information spread by the camps of President Rodrigo Duterte, Marcos, Jr. and others. News reports have quoted both Marcos Jr. and Duterte calling each other “a close friend.” VP Leni belongs to and leads the opposition party and was not Duterte’s choice to become vice president. Duterte’s spokesperson Harry Roque said that the president could step down from his post if Marcos, Jr. had succeeded in overturning his vice-presidential election defeat. Duterte believes that a woman like VP Leni is not fit to do his job.</p>
          </div>
          ...
          <p>
          <a href="https://businessmirror.com.ph/2021/11/20/educator-pens-open-letter-to-robredo-through-film/">Educator pens open letters to Robredo through film</a></p>
